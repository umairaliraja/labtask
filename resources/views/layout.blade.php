    ...
    <body>
      ...
      <div class="container-fluid">
          <div class="row"  style="background-color: #565454; height 50px; padding-top:8px; color: white; ">
            ...
            <div class="col-sm-1">
                <a href="{{url('welcome')}}"  style="text-decoration:none; color:white;"><p>Home</p></a>
              </div>
             <div class="col-sm-1" style="padding:0px;">
               ...
               <div class="col-sm-1"style="padding-left:8px;">
                  <a href="{{url('contact')}}" style="text-decoration:none; color:white;"><p>Contact</p></a>
              </div>
